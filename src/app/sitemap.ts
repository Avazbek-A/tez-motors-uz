...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPaths = [
    ...
    { path: "/used", changeFrequency: "daily" as const, priority: 0.8 },
    { path: "/deals", changeFrequency: "daily" as const, priority: 0.8 },
    { path: "/order", changeFrequency: "weekly" as const, priority: 0.8 },
    ...
    { path: "/showroom", changeFrequency: "weekly" as const, priority: 0.6 },
    ...
    { path: "/delivered", changeFrequency: "weekly" as const, priority: 0.6 },
