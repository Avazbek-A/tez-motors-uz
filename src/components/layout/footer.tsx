          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 bg-neon-green/10 hover:bg-neon-green/20 text-neon-green border border-neon-green/30 rounded-none px-4 py-3 transition-all text-sm font-medium"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-neon-blue/10 hover:bg-neon-blue/20 text-neon-blue border border-neon-blue/30 rounded-none px-4 py-3 transition-all text-sm font-medium"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
