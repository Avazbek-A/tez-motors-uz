        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-white">Tez Motors</span>
            </Link>
            ...
            <ul className="space-y-2">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/70 hover:text-lime transition-colors text-sm"
                  >
                    {link.label[locale]}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 bg-green-600/20 hover:bg-green-600/30 text-green-400 rounded-xl px-4 py-3 transition-colors text-sm font-medium"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 rounded-xl px-4 py-3 transition-colors text-sm font-medium"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
