    ...
    <div ref={ref} className={cn("relative", className)}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-10 pl-10 pr-8 rounded-xl border border-border bg-foreground/5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-neon-blue/50 focus:border-neon-blue/50 transition-all"
        />
        {query && (
          <button
        ...
        <div className="absolute top-full mt-2 left-0 right-0 bg-card rounded-xl border border-neon-blue/20 z-50 overflow-hidden animate-fade-in">
          {results.map((car) => (
            <Link
              ...
              className="flex items-center gap-3 p-3 hover:bg-foreground/5 transition-colors border-b border-border last:border-0"
            >
          ...
          <Link
            ...
            className="block p-3 text-center text-sm text-neon-blue hover:bg-foreground/5 transition-colors font-medium"
          >
