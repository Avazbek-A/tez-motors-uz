...
const POSTS = [
  {
    ...
    body_uz: "## Import qanday ishlaydi\n\nTez Motors BYD, Chery, Haval, Geely, Changan va boshqa zavodlar bilan to'g'ridan-to'g'ri ishlaydi. Bu — vositachisiz, qo'shimcha ustamasiz va narxda kutilmagan o'z    cover_image: "/images/ev_logistics_truck.png",
  ...
  },
  {
    ...
    cover_image: "/images/byd_song_plus.png",
